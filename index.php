  ...
  <div id="myCarousel" class="my-Carousel carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="images/1.jpg" style="width:100%; height: 800px;">

        <div class="carousel-caption">
          <h1>Open Source Hackathon</h1>
          <p>2K19</p>
<h1>
	           <a class="btn btn-white" data-scroll href="#reg"><h2>Register Now</h2></a>
      ...
      <div class="item">
        <img src="images/2.jpg"  style="width:100%; height: 800px;">
        <div class="carousel-caption">
          <h1>
	           <a class="btn btn-white" data-scroll href="#reg"><h2>Register Now</h2></a>
    		</h1> 
      ...
      <div class="item">
        <img src="images/3.jpg"  style="width:100%; height: 800px;">
        <div class="carousel-caption">
          <h1 style="font-size: 50%">win</h1>
          <p>Prices!</p>
          <h1>
	           <a class="btn btn-white" data-scroll href="#reg"><h2>Register Now</h2></a>
...
<div class="footer" title="Developer Info">
